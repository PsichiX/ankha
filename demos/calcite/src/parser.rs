...
mod tests {
    ...
    fn test_parsers() {
        ...
        let (rest, value) = registry
            ...
            .unwrap();
        assert_eq!(rest, "");
        assert_eq!(value.consume::<String>().ok().unwrap().as_str(), "(group_reversed (call_function (fn \"sub\")) (group_reversed (call_function (fn \"mul\")) (group_reversed (call_function (fn \"add\")) (lit f64 3) (lit f64 4)) (lit f64 2)) (group_reversed (call_function (fn \"div\")) (lit f64 1) (lit f64 5)))");
